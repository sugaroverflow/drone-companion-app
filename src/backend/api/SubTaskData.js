module.exports = {
  subtasks: [
    ...
    },
    {
      ...
      "task_id": "1",
      "titleEng":
        "User Canadian airspace data to determin a location for your flight that is outside of airspace.",
      "titleFra":
        "User Canadian airspace data to determin a location for your flight that is outside of airspace. (fr)",
      "guidanceEng":
