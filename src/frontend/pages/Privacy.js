...
Web Analytics
ESDC is responsible for the Government of Canada website, Canada.ca, as described under Orders in Council 2005-1637 and 2014-0349. Under the Government of Canada Directive on the Management of Communications, ESDC has also been identified as the Principal Publisher for the Canada.ca website. This includes responsibilities for web analytics, which is the collection, analysis, and reporting of web traffic data. Web analytics are done to help determine how Canada.ca can be improved to better serve Canadians and other visitors.

In its role as Principal Publisher, ESDC is responsible for the administration of the tools used by the Government of Canada for web analytics. ESDC also performs government-wide web analytics under the authority of Section 5 of the Department of Employment and Social Development Act.
...
downloading and installing a browser add-on from Adobe and/or Google that prevents your visit data from being used.
